...
TOOL_SCHEMAS: List[Dict[str, Any]] = [
    ...
    tool("materials_list", "Count blocks by type for the current build (a shopping list for survival: stacks and totals).", {}),
    tool("get_player", "Player position, facing (north/east/south/west), yaw/pitch and the block they are looking at.", {}),
    tool("say", "Send a short one-line message to the player's chat (progress updates between stages, the brief, what changed).", {"text": _s("Message text (one line, <= 200 chars)")}, ["text"]),
